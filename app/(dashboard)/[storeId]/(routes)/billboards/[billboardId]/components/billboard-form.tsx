...
export const BillboardForm : React.FC<BillboardFormProps> = ({
    ...
    const description = initialData ? "Update your billboard." : "Add a new billboard.";
    ...
    const onSubmit = async (data: BillboardFormValues) => {
        try {
            ...
            if(initialData) {
                ...
                console.log("patched", params.billboardId );
            } else {
    ...
    const onDelete = async () => {
        try {
            ...
            toast.error("Make sure you removed all categories using this billboard first, then try again.")
        } finally {
            setLoading(false);
            setOpen(false);
        }
